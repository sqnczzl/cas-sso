...
public class AuthenticationViaFormAction {
    ...
    public final String submit(final RequestContext context, final Credentials credentials, final MessageContext messageContext) throws Exception {
        ...
        logger.info("authoritativeLoginTicket : "+authoritativeLoginTicket);
        
        final String providedLoginTicket = WebUtils.getLoginTicketFromRequest(context);
        logger.info("providedLoginTicket : " +providedLoginTicket);
        ...
        logger.info("ticketGrantingTicketId : "+WebUtils.getTicketGrantingTicketId(context));
        
        final Service service = WebUtils.getService(context);
        
        logger.info("service : "+WebUtils.getTicketGrantingTicketId(context));
        logger.info("get renew: "+context.getRequestParameters().get("renew"));
        ...
        try {
            ...
            logger.info("getTicketGrantingTicketId : "+WebUtils.getTicketGrantingTicketId(context));
